...
public class TrashbinEnemy : MonoBehaviour
{
    ...
    public IEnumerator OnAttack()
    {
        ...
        trash = Object.Instantiate(trashPrefab, new Vector3(transform.position.x + transform.localScale.x / 2.0f * 1.1f, transform.position.y, 0), new Quaternion());
        trash.transform.GetComponent<Rigidbody2D>().AddForce(new Vector2(100.0f, 500.0f));
